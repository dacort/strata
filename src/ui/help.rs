...
pub fn render_help(frame: &mut Frame, area: Rect) {
    ...
    let help_lines = vec![
        ...
        keybinding_line("Enter", "Open / navigate into"),
        keybinding_line("Backspace", "Go back"),
        keybinding_line("g", "Go to first"),
        keybinding_line("G", "Go to last"),
        Line::from(""),
        Line::from(vec![
            Span::styled("  Actions", Style::default().fg(Color::Yellow).add_modifier(Modifier::BOLD)),
        ]),
        Line::from(""),
        keybinding_line("r", "Refresh listing"),
        keybinding_line("p", "Open in pager"),
        keybinding_line("d", "Download file"),
        keybinding_line("Tab", "Switch focus"),
        Line::from(""),
        Line::from(vec![
